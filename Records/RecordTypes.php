...
class CashLetterHeader  extends Record 
{
	...
	$fields[4]  = new Fields\FieldRoutingNumber(4, 'ECE Instituion',    Field::USAGE_MANDATORY,   14);
...
class ImageViewAnalysis extends Record
{
	...
	$fields[27] = new Fields\Predefined\ImageInfo\FieldImageInfoUsability(27, 'Date Usability',                        28);
	$fields[28] = new Fields\Predefined\ImageInfo\FieldImageInfoUsability(28, 'Payee Usability',                       29);
	$fields[29] = new Fields\Predefined\ImageInfo\FieldImageInfoUsability(29, 'Convenience Amount Usability',          30);
	$fields[30] = new Fields\Predefined\ImageInfo\FieldImageInfoUsability(30, 'Legal Amount Usability',                31);
	$fields[31] = new Fields\Predefined\ImageInfo\FieldImageInfoUsability(31, 'Signature Usability',                   32);
	$fields[32] = new Fields\Predefined\ImageInfo\FieldImageInfoUsability(32, 'Payor Name and Address Usability',      33);
	$fields[33] = new Fields\Predefined\ImageInfo\FieldImageInfoUsability(33, 'MICR Line Usability',                   34);
	$fields[34] = new Fields\Predefined\ImageInfo\FieldImageInfoUsability(34, 'Memo Line Usability',                   35);
	$fields[35] = new Fields\Predefined\ImageInfo\FieldImageInfoUsability(35, 'Payor Bank Name and Address Usability', 36);
	$fields[36] = new Fields\Predefined\ImageInfo\FieldImageInfoUsability(36, 'Payee Endorsement Usability',           37);
	$fields[37] = new Fields\Predefined\ImageInfo\FieldImageInfoUsability(37, 'BOFD Endorsement Usability',            38);
