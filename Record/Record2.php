 ...
 */
class Record2 implements \X937\Record\RecordInterface {
    /**
    ...
    public function __construct(array $recordTemplate) {
        ...
        foreach ($fields as $id => $fieldTemplate) {
            ...
            $fieldIndex = $id - 1;
            $fieldName  = $fieldTemplate[Field2::PROP_NAME];
            $this->fields[$fieldIndex] = new \X937\Fields\Field2($fieldTemplate);
    ...
    public function parse(string $data, string $dataType = X937\Util::DATA_EBCDIC): bool {
        ...
        foreach ($this->fields as $field) {
            ...
            $fieldPosition = $fieldTemplate[Field2::PROP_POSITION] - 1;
            $fieldSize     = $fieldTemplate[Field2::PROP_LENGTH];
            
            if (isset($fieldTemplate[Field2::PROP_VARIABLEPOSITION])) {
                $positionArray = explode('+', $fieldTemplate[Field2::PROP_VARIABLEPOSITION]);
            ...
            if(isset($fieldTemplate[Field2::PROP_VARIABLELENGTH])) {
                $lengthVariable = $fieldTemplate[Field2::PROP_VARIABLELENGTH];
            ...
            if (($dataType === \X937\Util::DATA_EBCDIC) && 
                    ($fieldTemplate[Field2::PROP_TYPE] != Field2::TYPE_BINARY)) {
            ...
            if (isset($fieldTemplate[Field2::PROP_VALUEKEY])) {
                $keyArray[$fieldTemplate[Field2::PROP_VALUEKEY]] = $asciiValue;
            }
