...
class CashLetterHeader extends Record 
{
	...
	$fields[1]  = new Fields\Predefined\RecordType(Fields\Predefined\RecordType::VALUE_CASH_LETTER_HEADER);
	$fields[2]  = new Fields\Predefined\FieldCollectionType(Record::TYPE_CASH_LETTER_HEADER);
	...
	$fields[9]  = new Fields\Predefined\FieldDocType(Record::TYPE_CASH_LETTER_HEADER);
